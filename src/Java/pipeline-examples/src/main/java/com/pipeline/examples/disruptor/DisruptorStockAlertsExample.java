...
/** Stock trading alerting example using Disruptor + Pipeline Services. */
public final class DisruptorStockAlertsExample {

  /** Typed pipeline: MarketDataEvent -> Enriched -> Alert */
