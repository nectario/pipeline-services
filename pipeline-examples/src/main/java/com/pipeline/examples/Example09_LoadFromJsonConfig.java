...
public final class Example09_LoadFromJsonConfig {
  private Example09_LoadFromJsonConfig() {}

  public static void run() throws Exception {
    try (InputStream in = Example09_LoadFromJsonConfig.class.getResourceAsStream("/pipelines/clean_text.json")) {
